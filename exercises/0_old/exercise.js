...
// const userInput = parseInt(prompt("Enter the value of n to calculate the n-th Fibonacci number:"));
//
// // Check if the input is a valid number
// if (!isNaN(userInput) && userInput >= 0) {
//     // Calculate and display the Fibonacci number
//     console.log(`The ${userInput}-th Fibonacci number is: ${fibonacci(userInput)}`);
// } else {
...
//     console.log(`The factorial of ${userInput} is: ${factorial(userInput)}`);
// } else {
//     console.log("Please enter a valid non-negative integer.");
// }
